...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/123/client/style/sign_in.css">
...
<body>
    <div class="main">
        ...
        <div class="bod">
            <div class="log">Login in File Transfer</div>


            <div class="image-box">
                <img src="http://localhost/123/client/style/accets/user/defaultUser.png">
            </div>
            ...
            <div class="input-data data-input-block">
                <button type="button" class="btn btn-success" id="myBtnStyle">Login</button>
            </div>
    ...
    <script src="http://localhost/123/client/script/sign_in.js"></script>
</body>
</html>